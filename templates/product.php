...
<a class="back-link" href="<?= e(url('catalogo')) ?>">← Volver al catálogo</a>
<article class="product-detail">
    <div class="cover cover--large">
        <?php if ($product['imagen']): ?>
            <img src="<?= e($product['imagen']) ?>" alt="Portada de <?= e($product['nombre']) ?>">
        <?php else: ?>
    ...
    <div>
        ...
        <?php if ((int) $product['stock'] > 0): ?>
            <p class="stock stock--available">Disponible · <?= e($product['stock']) ?> unidades</p>
        ...
        <?php else: ?>
            <p class="stock stock--empty">Agotado temporalmente</p>
        <?php endif; ?>
    </div>
</article>
